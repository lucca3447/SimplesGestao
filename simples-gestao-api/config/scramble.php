...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Documentação interativa da API REST SimplesGestão. Sistema de gestão para pequenos negócios desenvolvido em Laravel 11 e PostgreSQL com autenticação Sanctum.',
    ],

    'ui' => [
        'title' => 'SimplesGestão API Docs',
    ],
